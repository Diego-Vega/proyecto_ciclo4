                    ...
                    <div id="container">
                        <div className="product-details">
                            ...
                            <i className="information">
                                "La poderosisima Silla de G2, los mejores se han
                                sentado en esta silla Como MixWell, Koldamente,
                                Nukye, grandes jugadores profesionales de G2.
                                Firmada por el mismiso Lucas Rojo. Con esta
                                silla no tendras mas excusas asi que pasaras de
                                ser un completo fracaso en los E-Sport a ser la
                                estrella del Torneo."
                            </i>
                        ...
                        <div className="product-image">
                            ...
                            <div className="info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <strong>Detalles: </strong>Gamer,
                                        Ergonomica, con rueditas
                                    </li>
                                </ul>
                            </div>
                        </div>
